...
export const styles = StyleSheet.create({
    ...
    maintenanceButton:{zIndex:0,justifyContent:'center',alignItems:'center',borderRadius:10,width:Window.width/4,height:Window.height/20,backgroundColor:AppColors.yellow},
    profileContainer: {
